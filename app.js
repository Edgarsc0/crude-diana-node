...
const con=mysql.createConnection({
    ...
    password:process.env.PSW||"Hal02012()",
...
/**
 * ESTA RUTA RESPONDE AL ONREQUEST.
 * MANDA A IMPRIMIR LA CONSULTA DE LIBROS.
 * 
 * NOTESE QUE EL BOTON "AGREGAR" QUE REDIRECCIONA A "CREATE"
 * ES UN ARCHIVO ESTATICO, ES DECIR NO SUFRE MODIFICACIONES POR PARTE
 * DEL BACKEND COMO SI SUCEDE CON LA CONSULTA PUES LA TABLA ES VARIABLE.
 */
app.get("/",(req,res)=>{
    res.write(`
    <!doctype html>
        ...
        <body>
            ...
            <div class="container mt-3">
                <div class="mt-4 p-5 bg-primary text-white rounded">
                    <h1>Crude Libros</h1> 
                    <p>Cárdenas Mayén Diana Araceli</p> 
                </div>
            <br>
    ...
    con.query(`SELECT * FROM LIBROS`,(err,result)=>{
        ...
        res.write(`
            ...
            <div class="d-grid">
                <a href="create.html" type="button" class="btn btn-primary btn-block">Agregar</a>
            </div>
        `);
        res.end();
    });
